<?php
// src/AppBundle/Utils/Parser.php

namespace AppBundle\Utils;

class Parser
{
  public function parserTexarea($content){
    // Parsage des balises
    $zcode = array(  
      ...
      '`&lt;citation nom=&quot;(.+)&quot;lien=&quot;(.+)&quot;&gt;(.+)&lt;/citation&gt;`isU',
    ...
    $html = array(  
      ...
      '<blockquote class="citation"><q>$2</q><footer>- par $1</footer></blockquote>',
      '<blockquote class="citation" cite="$1"><q>$2</q><footer>- $1</footer></blockquote>',
      '<blockquote class="citation" cite="$2"><q>$3</q><footer>- $2 par $1</footer></blockquote>',
      '<blockquote class="citation"><q>$1</q></blockquote>',
      '<span class="$1">$2</span>'
    ); 
